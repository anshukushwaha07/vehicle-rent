...
// A simple social login button component (can be moved to a shared UI folder)
                ...
                <div className="w-full max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 shadow-2xl rounded-2xl overflow-hidden border">
                    {/* Left Panel: Image */}
                     <div className="hidden md:block">
                        <img 
                            src="https://placehold.co/800x1000/10B981/FFFFFF?text=Join+Us&font=raleway" 
                    ...
                    <div className="p-8 sm:p-12 bg-card text-card-foreground">
                        ...
                        <p className="text-center text-sm text-muted-foreground mt-8">
                            Already have an account? <a href="/login" onClick={(e) => { e.preventDefault(); navigate('/login'); }} className="text-primary hover:underline cursor-pointer">Log in</a>
                        </p>
                    </div>
                </div>
            </main>
